...
if(a>b && a>c && a>d){
printf("first number is greatest among all four entries");
}
else if(b>a && b>c && b>d){
printf("second number is greatest among all four entries");
}

else if(c>a && c>b && c>d){
printf("Third number is greatest among all four entries");
}
